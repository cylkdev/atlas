defmodule AtlasProvider.Strings do
  @moduledoc """
  String utilities for `AtlasProvider`.
  ...
  ## Examples
      ...
      iex> AtlasProvider.Strings.string_to_atom("mcp_string_doctest_existing", to_existing_atom: true)
      {:ok, :mcp_string_doctest_existing}

      iex> AtlasProvider.Strings.string_to_atom(
      ...>   "mcp_string_doctest_minted",
      ...>   atomizeable_keys: ["mcp_string_doctest_minted"]
      ...> )
      {:ok, :mcp_string_doctest_minted}

      iex> AtlasProvider.Strings.string_to_atom("blocked", atomizeable_keys: ["other"])
      :error
  ...
  #        b. `Application.get_env(:atlas_provider, :atomizeable_keys)`,
  #        c. `:all`.
  ...
  ## Parameters
    ...
    - `opts` — `keyword()`. Recognised keys:
        ...
        * `:atomizeable_keys` — `:all | MapSet.t() | list() | nil`.
          ...
          `Application.get_env(:atlas_provider, :atomizeable_keys)`, then to `:all`". Any other
  ...
  ## Examples
      ...
      iex> AtlasProvider.Strings.string_to_atom("Elixir.Enum", to_existing_atom: true)
      {:ok, Enum}

      iex> AtlasProvider.Strings.string_to_atom("non_existing_atom", atomizeable_keys: ["non_existing_atom"])
